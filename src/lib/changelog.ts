...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "**💷 A moeda passa a ser a da propriedade.** O GA4 devolve números sem moeda, por isso a receita do Kings Gyms — loja britânica — saía com o símbolo € do default. O relatório e-commerce passa a ler a moeda da própria propriedade GA4 (ou da loja Shopify, quando o dinheiro vem de lá) e só depois cai na configurada.",
  ...
  },
  {
    ...
    highlights: [
      "**🎥 Três tutoriais novos:** acesso à conta **Google Ads**, acesso ao **Meta Business** e acesso ao **Google Merchant Center**. Os placeholders «Vídeo em breve» destes três passos deixaram de existir. (O do Merchant Center foi trocado logo a seguir pela versão final.)",
  ...
  },
  {
    ...
    highlights: [
      ...
      "**📝 Descrições de GEO cortadas para uma linha.** Saíram também o bloco de sub-perguntas, o de «keywords do plano perguntadas a uma IA» e a coluna de pesquisas/mês da tabela de AI Overview — ali a pergunta é «a Google responde com IA e cita-nos?», e o volume só empurrava as colunas que respondem a isso.",
    ],
  },
  {
    version: "76.59",
